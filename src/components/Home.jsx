...
const Home = () => {
  return (
    <div id='home' className='container mx-auto p-5 text-left  flex items-center justify-between bg-fixed h-400'>
      <div className='md:w-50 lg:text-left md:text-center  sm:text-center text-sm'> 
        ...
        <button className='bg-black text-white p-2 rounded-lg'>Download <span className='uppercase'>cv</span></button>
      </div>
      ...
      <div class="flex flex-col h-30 justify-center bg-gray-200 p-4 rounded-full md:block">
        ...
        <a href='https://github.com/users/anis87-create/projects/1' target='_blank' rel="noreferrer"><img src={github} alt="" class="w-20" ></img></a>
     </div>
