  ...
  return (
    <section id='home' className='container mx-auto p-5 text-left  flex items-center justify-between bg-fixed h-400'>
      <div className='md:w-50 lg:text-left md:text-center  sm:text-center md:text-xl text-sm'> 
        ...
        <p className='mb-4 mt-4  w-[600px] sm:mb-4'>Développeur Full Stack JavaScript avec plus de 3 ans d'expérience dans le développement d'applications SaaS et d'interfaces web modernes. Spécialisé en React.js, Next.js et Node.js, avec un intérêt particulier pour les outils IA appliqués au développement logiciel.</p>
